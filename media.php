...
<head>
    ...
    <title>NATVOM-Media</title> <link rel="icon" href="assets/img/natvom.png">
    ...
    <div style="height: 250px;background: url(&quot;assets/img/pexels-anna-nekrashevich-6476118.jpg&quot;) center / cover no-repeat;margin-top: 8px;">
        <div class="d-flex justify-content-center align-items-center" style="height:inherit;min-height:initial;width:100%;position:absolute;left:0;background-color:rgba(30,41,99,0.53);">
            <div class="d-flex align-items-center order-12" style="height:200px;">
                <div class="container">
                    <h1 class="text-center" style="color:  #ffff;font-size: 25px;font-weight: bold;">Media</h1>
                    <h3 class="text-center" style="color: rgb(242,245,248);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;font-size: 16px;"><a href="index.php" style="color: rgb(255,255,255);">Home</a> &gt; Media</h3>
                </div>
            </div>
        </div>
    </div>
    <div class="jumbotron" style="background: rgb(255,255,255);">
        <h1 style="font-size: 20px;text-align: center;color:  rgb(52,118,27);">Coming soon&nbsp;<i class="fa fa-search"></i></h1>
    </div>
