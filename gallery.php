...
<head>
    ...
    <title>NATVOM-Gallery</title> <link rel="icon" href="assets/img/natvom.png">
...
<header>
    ...
    <div style="height: 250px;background: url(&quot;assets/img/pexels-anna-nekrashevich-6476118.jpg&quot;) center / cover no-repeat;margin-top: 8px;">
        <div class="d-flex justify-content-center align-items-center" style="height:inherit;min-height:initial;width:100%;position:absolute;left:0;background-color:rgba(30,41,99,0.53);">
            <div class="d-flex align-items-center order-12" style="height:200px;">
                <div class="container">
                    <h1 class="text-center" style="color: #ffff;font-size: 25px;font-weight: bold;">Gallery</h1>
                    <h1 class="text-center" style="color: #ffff;font-size: 25px;font-weight: bold;"><i class="fa fa-quote-left" style="color: rgb(255,255,255);"></i><span style="font-size: 16px;font-weight: 40;"><strong>&nbsp;FIND MORE IMAGES&nbsp;</strong></span><i class="fa fa-quote-right" style="color: rgb(255,255,255);"></i><strong>&nbsp;</strong></h1>
                    <h3 class="text-center" style="color: rgb(242,245,248);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;font-size: 16px;"><a href="index.php" style="color: rgb(255,255,255);">Home</a> &gt; Gallery</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <?PHP          
        ...
        while ($rows=mysqli_fetch_array($result)) {
            ...
            ?> 
        <div class="container">
            <h1 class="text-lowercase text-center" style="color: rgb(52,118,27);font-size: 20px;font-weight: 500;padding-top: 14px;"><?php echo $rows['category'] ?></h1>
        ...
        ?>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a data-lightbox="gallery" href="admin/gallery/<?php echo $rows1['picture']?>"><img class="img-fluid" src="admin/gallery/<?php echo $rows1['picture']?>" alt="<?php echo $rows['category']?>"></a></div>
                <?php
