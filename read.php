...
<?php
    ...
    if (mysqli_connect_errno())
      ...
      $re=mysqli_query($conn,"select * from article where article_id='$id'") or die(mysqli_error($conn));
      $row=mysqli_fetch_array($re);
      $vi=$row['viewer'];
      $edit=mysqli_query($conn,"UPDATE article SET viewer=($vi+1) where article_id='$id'"); 
      
    ?> 
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>NATVOM -<?php echo $row['heading']?></title> <link rel="icon" href="assets/img/natvom.png">
...
<header>
    ...
    <div style="height: 250px;background: url(&quot;assets/img/pexels-anna-nekrashevich-6476118.jpg&quot;) center / cover no-repeat;margin-top: 8px;">
        <div class="d-flex justify-content-center align-items-center" style="height:inherit;min-height:initial;width:100%;position:absolute;left:0;background-color:rgba(30,41,99,0.53);">
            <div class="d-flex align-items-center order-12" style="height:200px;">
                <div class="container">
                    <h1 class="text-center" style="color: #ffff;font-size: 25px;font-weight: bold;">Blog</h1>
                    <h1 class="text-center" style="color: #ffff;font-size: 25px;font-weight: bold;"><i class="fa fa-quote-left" style="color: rgb(255,255,255);"></i><span style="font-size: 16px;font-weight: 40;"><strong>&nbsp;FIND MORE STORIES&nbsp;</strong></span><i class="fa fa-quote-right" style="color: rgb(255,255,255);"></i><strong>&nbsp;</strong></h1>
                    <h3 class="text-center" style="color: rgb(242,245,248);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;font-size: 16px;"><a href="index.php" style="color: rgb(255,255,255);">Home</a> &gt; <a href="blog.php" style="color: rgb(255,255,255);">Blog</a></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="article-clean">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-xl-8 offset-lg-1 offset-xl-2">
                    <div class="intro">
                        <h3 class="text-center"><?php echo $rows['heading']?></h3>
                        <p class="text-center"><span class="by">by</span> <a href="#" style="font-family: Asap, sans-serif;"><?php echo $rows['name'].''.$rows['surname'] ?></a> <span class="date" style="font-family: Asap, sans-serif;"><?php echo $rows['date']?> </span></p><img class="img-fluid"src="admin/articles/<?php echo $rows['picture']?>">
                    </div>
                    <div class="text" style="font-family: Asap, sans-serif;">
    ...
    <footer class="footer-basic" style="background: rgb(31,31,32);">
        ...
        <p class="copyright" style="color: rgb(255,255,255);opacity: 0.78;">NATVOM© 2021</p>
    </footer><a href="#top">
        <div id="scroll-to-top" style="background: rgb(255,255,255);"><i class="fa fa-chevron-up" style="color: #ffff;"></i></div>
    </a>
